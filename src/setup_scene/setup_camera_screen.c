...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   setup_camera_screen.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: katakada <katakada@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/22 15:22:11 by katakada          #+#    #+#             */
/*   Updated: 2025/07/28 14:26:44 by katakada         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	set_screen_pos(t_scene *scene)
{
	...
	screen_xy_offset = add_vectors(scene->screen.x_half, scene->screen.y_half);
	scene->screen.pos = add_vectors(screen_center_pos, screen_xy_offset);
}
