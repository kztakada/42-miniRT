...
/*   Updated: 2025/07/21 21:54:05 by katakada         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_vector	calc_screen_dot_pos(t_scene *scene, int x, int y)
{
	...
	diff_v[0] = scale_vector((float)x + fix_f[0], scene->screen.qx);
	diff_v[1] = scale_vector((float)flipped_y + fix_f[1], scene->screen.qy);
